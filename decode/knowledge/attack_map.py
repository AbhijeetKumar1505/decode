...
CAPABILITY_ATTACK: dict[str, AttackTechnique] = {
    ...
    "service_detection": AttackTechnique(
        "T1046", "Network Service Discovery", "Discovery"
    ),
    "os_detection": AttackTechnique(
    ...
    "password_cracking": AttackTechnique(
        "T1110.002", "Brute Force: Password Cracking", "Credential Access"
    ),
    "exploit_search": AttackTechnique(
        "T1588.005", "Obtain Capabilities: Exploits", "Resource Development"
    ),
}


def attack_for_capability(capability: str) -> AttackTechnique | None:
